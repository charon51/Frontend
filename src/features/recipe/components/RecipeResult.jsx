...
const RecipeResult = () => {
    ...
    if (isSuccess) {
                ...
                {ids?.length ? (
                    <div className="flex shadow-lg flex-1">
                        <div className="flex flex-col flex-1">
                            <div className="bg-orange-300 p-3 text-sm">
                    ...
                    <div className="flex justify-center items-center">
                        <p className="flex flex-col justify-center items-center gap-1 font-bold text-orange-400">
                            <TbError404 className="text-5xl" />
                            Vaya... Receta no encontrada...
                        </p>
                    </div>
                )}
            </div>
        ...
        return (
            <div className="h-screen pt-[136px] flex justify-center items-center flex-1">
                <p className="flex flex-col justify-center items-center gap-1 font-bold text-orange-700">
        ...
        return (
            <div className="h-screen pt-[136px] flex flex-col justify-center items-center flex-1 bg-white bg-no-repeat bg-cover">
                <p className="flex flex-col justify-center items-center text-orange-500 gap-1 font-bold break-words">
                    <TbDatabaseSearch className="text-5xl" />
                    Buscar recetas por nombres de alimentos o ingredientes
                </p>
            </div>
        );
    }
